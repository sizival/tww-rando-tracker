...
const LOCATION_MAPPING = {
  ...
  // Seven-Star Isles
  0x2380ff: { generalLocation: 'Seven-Star Isles', detailedLocation: 'Center Lookout Platform' },
  0x238100: { generalLocation: 'Seven-Star Isles', detailedLocation: 'Northern Lookout Platform' },
  0x238101: { generalLocation: 'Seven-Star Isles', detailedLocation: 'Southern Lookout Platform' },
  ...
  0x23810f: { generalLocation: 'Forsaken Fortress Sector', detailedLocation: 'Sunken Treasure' },
  0x238110: { generalLocation: 'Star Island', detailedLocation: 'Sunken Treasure' },
  0x238111: { generalLocation: 'Northern Fairy Island', detailedLocation: 'Sunken Treasure' },
  0x238113: { generalLocation: 'Crescent Moon Island', detailedLocation: 'Sunken Treasure' },
  0x238115: { generalLocation: 'Overlook Island', detailedLocation: 'Sunken Treasure' },
  0x238116: { generalLocation: 'Four-Eye Reef', detailedLocation: 'Sunken Treasure' },
  0x238117: { generalLocation: 'Mother and Child Isles', detailedLocation: 'Sunken Treasure' },
  0x238118: { generalLocation: 'Spectacle Island', detailedLocation: 'Sunken Treasure' },
  0x238119: { generalLocation: 'Windfall Island', detailedLocation: 'Sunken Treasure' },
  0x23811a: { generalLocation: 'Pawprint Isle', detailedLocation: 'Sunken Treasure' },
  0x23811b: { generalLocation: 'Dragon Roost Island', detailedLocation: 'Sunken Treasure' },
  0x23811c: { generalLocation: 'Flight Control Platform', detailedLocation: 'Sunken Treasure' },
  0x23811d: { generalLocation: 'Western Fairy Island', detailedLocation: 'Sunken Treasure' },
  0x23811e: { generalLocation: 'Rock Spire Isle', detailedLocation: 'Sunken Treasure' },
  0x23811f: { generalLocation: 'Tingle Island', detailedLocation: 'Sunken Treasure' },
  0x238120: { generalLocation: 'Northern Triangle Island', detailedLocation: 'Sunken Treasure' },
  0x238121: { generalLocation: 'Eastern Fairy Island', detailedLocation: 'Sunken Treasure' },
  0x238122: { generalLocation: 'Fire Mountain', detailedLocation: 'Sunken Treasure' },
  0x238123: { generalLocation: 'Star Belt Archipelago', detailedLocation: 'Sunken Treasure' },
  0x238124: { generalLocation: 'Three-Eye Reef', detailedLocation: 'Sunken Treasure' },
  0x238126: { generalLocation: 'Cyclops Reef', detailedLocation: 'Sunken Treasure' },
  0x238127: { generalLocation: 'Six-Eye Reef', detailedLocation: 'Sunken Treasure' },
  0x238128: { generalLocation: 'Tower of the Gods Sector', detailedLocation: 'Sunken Treasure' },
  0x238129: { generalLocation: 'Eastern Triangle Island', detailedLocation: 'Sunken Treasure' },
  0x23812a: { generalLocation: 'Thorned Fairy Island', detailedLocation: 'Sunken Treasure' },
  0x23812b: { generalLocation: 'Needle Rock Isle', detailedLocation: 'Sunken Treasure' },
  0x23812c: { generalLocation: 'Islet of Steel', detailedLocation: 'Sunken Treasure' },
  0x23812f: { generalLocation: 'Private Oasis', detailedLocation: 'Sunken Treasure' },
  0x238130: { generalLocation: 'Bomb Island', detailedLocation: 'Sunken Treasure' },
  0x238131: { generalLocation: "Bird's Peak Rock", detailedLocation: 'Sunken Treasure' },
  0x238132: { generalLocation: 'Diamond Steppe Island', detailedLocation: 'Sunken Treasure' },
  0x238133: { generalLocation: 'Five-Eye Reef', detailedLocation: 'Sunken Treasure' },
  0x238134: { generalLocation: 'Shark Island', detailedLocation: 'Sunken Treasure' },
  0x238135: { generalLocation: 'Southern Fairy Island', detailedLocation: 'Sunken Treasure' },
  0x238136: { generalLocation: 'Ice Ring Isle', detailedLocation: 'Sunken Treasure' },
  0x238137: { generalLocation: 'Forest Haven', detailedLocation: 'Sunken Treasure' },
  0x238139: { generalLocation: 'Horseshoe Island', detailedLocation: 'Sunken Treasure' },
  0x23813b: { generalLocation: 'Headstone Island', detailedLocation: 'Sunken Treasure' },
  0x23813d: { generalLocation: 'Angular Isles', detailedLocation: 'Sunken Treasure' },
  0x23813e: { generalLocation: 'Boating Course', detailedLocation: 'Sunken Treasure' },
  0x23813f: { generalLocation: 'Five-Star Isles', detailedLocation: 'Sunken Treasure' },

  // Triforce Salvaging (still called "Sunken Treasure" in the tracker)
  0x238112: { generalLocation: 'Gale Isle', detailedLocation: 'Sunken Treasure' },
  0x238114: { generalLocation: 'Seven-Star Isles', detailedLocation: 'Sunken Treasure' },
  0x238125: { generalLocation: 'Greatfish Isle', detailedLocation: 'Sunken Treasure' },
  0x23812d: { generalLocation: 'Stone Watcher Island', detailedLocation: 'Sunken Treasure' },
  0x23812e: { generalLocation: 'Southern Triangle Island', detailedLocation: 'Sunken Treasure' },
  0x238138: { generalLocation: 'Cliff Plateau Isles', detailedLocation: 'Sunken Treasure' },
  0x23813a: { generalLocation: 'Outset Island', detailedLocation: 'Sunken Treasure' },
  0x23813c: { generalLocation: 'Two-Eye Reef', detailedLocation: 'Sunken Treasure' },
};
